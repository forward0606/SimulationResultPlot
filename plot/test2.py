...
class ChartGenerator:
    ...
    def __init__(self, dataName, Xlabel, Ylabel):
        ...
        AlgoName = ["ours-BD", "ours-AD", "ours-GD", "CCT", "DDC-WP", "DDC-BFS"] # "MyAlgo1", "MyAlgo2",

        leg = plt.legend(
            AlgoName,
            loc = 10,
            bbox_to_anchor = (0.40, 0.83),
        ...
        ax1.set_yticks([0, 600, 1200, 1800])
...
if __name__ == "__main__":
    ...
    ChartGenerator("demo2.ans", "Deadline Distribution", "# Served Requests");
